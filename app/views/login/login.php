...
<section>
    ...
    <div class="container">
                        ...
                        <form action="login" id="formLogin" method="post">
                                ...
                                <div class="col">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text login-input-group-text" id="email-addon"><i
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text login-input-group-text" id="password-addon"><i
                                                    class="fas fa-key"></i></span>
                                        </div>
                                        <input type="password" class="form-control" placeholder="Password"
                                            aria-label="Your Password" aria-describedby="password-addon" name="password"
                                            id="password">
                                    </div>
                                </div>
                            </div>
        ...
        <!-- Modal -->
        <div class="modal fade" id="firstLoginModal" tabindex="-1" role="dialog" aria-labelledby="firstLoginModal"
            aria-hidden="true">
